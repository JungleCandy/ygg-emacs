...
(use-package lsp-mode
  ...
  :commands lsp
  :init
  ;; Set up eldoc and flycheck preferences
  (setq lsp-eldoc-enable-hover nil        ;; Let lsp-ui handle eldoc
  ...
  ;; Hook into major modes here, without repeating setup
...
(defun find-sourcekit-lsp ()
  "Locate the sourcekit-lsp binary."
  (or (executable-find "sourcekit-lsp")
      (and (eq system-type 'darwin)
           (string-trim (shell-command-to-string "xcrun -f sourcekit-lsp")))
      "sourcekit-lsp"))  ;; fallback if all else fails
#+end_src
