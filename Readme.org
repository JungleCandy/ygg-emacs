...
(with-eval-after-load 'projectile
  (define-key my/project-map (kbd "f") #'counsel-projectile-find-file)
  (define-key my/project-map (kbd "s") #'counsel-projectile-rg)
  (define-key my/project-map (kbd "g") #'projectile-grep)
  (define-key my/project-map (kbd "x") #'projectile-find-references)
  (define-key my/project-map (kbd "p") #'counsel-projectile-switch-project)

  ;; Clean up Super bindings from packages
  (define-key projectile-command-map (kbd "s g") nil)
  (define-key projectile-command-map (kbd "s r") nil)
  (define-key projectile-command-map (kbd "s s") nil)
  (define-key projectile-command-map (kbd "s x") nil))
#+end_src
